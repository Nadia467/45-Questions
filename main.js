...
let names = ["Aliya", "Maryam", "Nazmeen", "Shumaila"];
names.forEach(name => {
    console.log(name);
});
...
let perNames = ["Aylia", "Maryam", "Nazmeen", "Shumaila"];
names.forEach(name => {
...
let favoriteTransports = ['Tesla', 'BMW ', 'Audi e-tron', 'Mercedes'];
...
let guestList = ["Maryam", "Nazmeen", "Huda"];
...
let Guestlist = ["Maryam", "Nazmeen", "Najma"];
...
let guests = ["Tania", "Maryam", "Laiba", "Nazmeen", "Najma", "Fouziz"];
...
let places = ["Cape Town", "Delhi", "England", "Bankok", "Amdabad"];
...
let dinnerguest = ["Tania", "Najma", "Laiba", "Huda"];
let numberofguest = dinnerguest.length;
...
let countries = ["Turkey", "Bangladesh", "China", "Japan"];
console.log(`\nList of countries:\n`);
...
let numbers = ["orange", "banana", 3, 4, 5,];
...
let number = 50;
console.log(number == 50 && number < 50); //false
console.log(number > 50 || number == 50); //true
console.log(number !== 50 && number > 50); //false
console.log(number >= 50 || number <= 50); //true
...
let favoriteFruits = ["mango", "kiwi", "drain"];
...
let users = ["Adim", "Eric", "John", "Alice", "David"];
...
let Users1 = ["Adim", "Eric", "John", "Alice", "David"];
...
let currentUsers = ["saba", "nora", "admin", "nadia", "shazma"];
let newUsers = ["john", "eric", "admin", "mk", "jd"];
...
// I really love pizza!
let favPizzas = ["cheese pizza", "BBQ chicken pizza", "Pepperoni pizza"];
...
let magicians1 = ["Merlin", "Gandalf", "Houdini"];
function show_great(magicians1) {
    magicians.forEach(magician => {
        console.log(magician);
    });
}
